...
+ (void)initializeDatosTest
{
    ...
    sucursales = [[NSArray alloc] initWithObjects:
                  [[NSArray alloc] initWithObjects:
                   @"QLS022", @"Zona Rosa", @"55896300", @"zonarosa@quicklearning.com", @"19.424213", @"-99.164464",nil],
                  [[NSArray alloc] initWithObjects:
                   @"QLS022", @"Polanco", @"55896300", @"polanco@quicklearning.com", @"19.433916", @"-99.181942",nil],
                  [[NSArray alloc] initWithObjects:
                   @"QLS022", @"Napoles", @"55896300", @"napoles@quicklearning.com", @"19.398217", @"-99.171213",nil],
                  [[NSArray alloc] initWithObjects:
                   @"QLS022", @"Cumbres", @"78899885", @"cumbres@quicklearning.com", @"25.698221", @"-100.351535",nil],
                  [[NSArray alloc] initWithObjects:
                   @"QLS022", @"San Luis Potosi", @"44996633", @"sanluispotosi@quicklearning.com", @"22.148516", @"-101.011321",nil],
                  [[NSArray alloc] initWithObjects:
                   @"QLS022", @"Arlington", @"11125541", @"arlington@quicklearning.com", @"32.744728", @"-97.059896",nil],
                  [[NSArray alloc] initWithObjects:
                   @"QLS022", @"Phoenix", @"88554466", @"phoenix@quicklearning.com", @"33.50969", @"-112.184452",nil],
                  [[NSArray alloc] initWithObjects:
                   @"QLS022", @"Las Vegas", @"33885544", @"lasvegas@quicklearning.com", @"36.164518", @"-115.060753",nil],
                nil];
